...
const GLfloat Cube::cube_vertices[] = {
...
Cube::Cube()
{
	...
	for (int i = 0; i < 12; i++)
	{
		TBNTriangle(&cube_vertices[24 * i], &Panel_triangle[42 * i]);
	}
...
void Cube::TBNTriangle(const GLfloat * vertex_input, GLfloat * vertex_output)
{
	glm::vec3 pos[3] = { 
